...
var KeyConfigs = (_KeyConfigs = {}, _defineProperty(_KeyConfigs, Keys.PLUS, {
    ...
    ariaLabel: i18n._('Multiply')
}), _defineProperty(_KeyConfigs, Keys.CUP, {
    type: KeyTypes.OPERATOR,
    ariaLabel: i18n._('Multiply'),
    icon: {
        type: IconTypes.MATH,
...
}), _defineProperty(_KeyConfigs, Keys.CAP, {
    type: KeyTypes.OPERATOR,
    ariaLabel: i18n._('Multiply'),
    icon: {
        type: IconTypes.MATH,
...
}), _defineProperty(_KeyConfigs, Keys.INFTY, {
    type: KeyTypes.VALUE,
    ariaLabel: i18n._('Multiply'),
    icon: {
        type: IconTypes.MATH,
...
}), _defineProperty(_KeyConfigs, Keys.CLOSURE, {
    type: KeyTypes.VALUE,
    ariaLabel: i18n._('Coordinate'),
    icon: {
        type: IconTypes.MATH,
...
}), _defineProperty(_KeyConfigs, Keys.HALFCOORDINATE, {
    type: KeyTypes.VALUE,
    ariaLabel: i18n._('Coordinate'),
    icon: {
        type: IconTypes.MATH,
...
}), _defineProperty(_KeyConfigs, Keys.HALFCLOSURE, {
    type: KeyTypes.VALUE,
    ariaLabel: i18n._('Coordinate'),
    icon: {
        type: IconTypes.MATH,
