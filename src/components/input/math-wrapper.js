...
const KeyActions = {
  ...
  // add
    ...
    [Keys.CLOSURE]: {str: 'closure', fn: CMD},
    [Keys.HALFCOORDINATE]: {str: 'halfcoordinate', fn: CMD},
    [Keys.HALFCLOSURE]: {str: 'halfclosure', fn: CMD},
...
//
    ...
    [Keys.CUP]: {str: 'cup', fn: CMD},
    [Keys.CAP]: {str: 'cap', fn: CMD},
    [Keys.INFTY]: {str: 'infty', fn: CMD},
